...
MODEL_NAME="vicuna-7b-random-pos-simpo-64k"

CUDA_VISIBLE_DEVICES=2,3 python gen_longbench.py \
    --model_path "/vepfs/wcf/G/zecheng/hf_models/Llama-2-7b-hf" \
    --peft_path "/vepfs/wcf/G/zecheng/ckpt/simpo_vicuna_64k/checkpoint-300/trainable" \
    --save_path ${SAVE_PATH} \
    --rope_theta=10000.0 \
    --rope_factor=16.0 --rope_type="linear" \
