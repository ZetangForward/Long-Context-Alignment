...
class DPOTrainer(Trainer):
    ...
    def __init__(
        ...
        load_from_cache_path: bool = False,
        cache_path: str = None,
    ):
        ...
        if ref_model:
            ...
            self.ref_model = None  # no ref_model
    ...
    def concatenated_inputs(
        ...
        # dict_keys(['prompt', 'chosen', 'rejected', 'chosen_span_id', 'rejected_span_id', 'chosen_input_ids', 'chosen_attention_mask', 'chosen_labels', 'rejected_input_ids', 'rejected_attention_mask', 'rejected_labels', 'prompt_input_ids', 'prompt_attention_mask'])
        for k in batch:
    ...
    def get_batch_logps(
        ...
        # print(per_token_logps.max())
        # print(per_token_logps.min())
        # print("loss_mask.sum(-1) are priented")
