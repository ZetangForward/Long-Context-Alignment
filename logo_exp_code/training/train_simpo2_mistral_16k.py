...
class CustomDataCollator:
    ...
    def inner_wrap_batch(self, batch_data, batch_id):
        ...
        suffix_rejected_input_ids, suffix_rejected_attention_mask, suffix_rejected_position_ids, suffix_rejected_labels = None, None, None, None
    ...
    def __call__(self, batch):
        ...
        if len(batch) == 1:
            ...
            wrap_batch['input_ids'] = batch[0]['chosen']['input_ids'][None, :]
            wrap_batch['attention_mask'] = batch[0]['chosen']['attention_mask'][None, :]
            wrap_batch['position_ids'] = batch[0]['chosen']['position_ids'][None, :]
            wrap_batch['chosen_labels'] = batch[0]['chosen']['labels'][None, :]
            wrap_batch['prefix_rejected_input_ids'] = batch[0]['reject_1']['input_ids'][None, :]
            wrap_batch['prefix_rejected_attention_mask'] = batch[0]['reject_1']['attention_mask'][None, :]
            wrap_batch['prefix_rejected_position_ids'] = batch[0]['reject_1']['position_ids'][None, :]
            wrap_batch['prefix_rejected_labels'] = batch[0]['reject_1']['labels'][None, :]
            wrap_batch['suffix_rejected_input_ids'] = batch[0]['reject_2']['input_ids'][None, :]
            wrap_batch['suffix_rejected_attention_mask'] = batch[0]['reject_2']['attention_mask'][None, :]
            wrap_batch['suffix_rejected_position_ids'] = batch[0]['reject_2']['position_ids'][None, :]
            wrap_batch['suffix_rejected_labels'] = batch[0]['reject_2']['labels'][None, :]
...
if __name__ == "__main__":
    ...
    if training_args.rope_type is not None:
        config.rope_scaling = {"type": training_args.rope_type, "factor": training_args.rope_factor}
