...
if __name__ == "__main__":
    ...
    # processed_data = dataset.map(map_fn, fn_kwargs={"tokenizer": tokenizer, "special_token_id": spe_token_id, "qa_size": 256, "max_embedding_size": 65536, "real_reference_size": 8192, "prefix_id": None, "suffix_id": None}, num_proc=24)
