...
#SBATCH --job-name=zecheng_v6_lcao    # 作业名
...
#SBATCH --output=logs/zecheng_v6_lcao_job_id-%J.out        # 标准输出重定向到job_id-<jobid>.out文件
#SBATCH --error=logs/zecheng_v6_lcao_job_id-%J.err         # 标准错误重定向到job_id-<jobid>.err文件
...
bash scripts/fix_lcao_llama3_dlcs_chunk_size_1024.sh
